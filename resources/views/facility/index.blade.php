...
<div class="container mt-5 mb-5">
    <div class="row mr-0 ml-0">
        ...
        <button class="btn btn-success btn-sm mr-1" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus"></i> Add Facility</button>
        {{-- Add facility modal --}}
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body" align="left">
                                                            ...
                                                            <div class="form-group row">
                                                                <div class="col-lg-9">
                                                                    {{Form::label('facility_name', 'Facility')}}
                                                                    {{Form::text('facility_name', $facility->facility_name, ['class' => 'form-control']) }}
                                                                </div>
                                                                <div class="col-lg-3">
                                                                    {{Form::label('facility_capacity', 'Capacity')}}
                                                                    {{Form::number('facility_capacity', $facility->facility_capacity, ['class' => 'form-control', 'placeholder' => '1', 'min' => '1'] )}}
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <div class="col-lg-6">
