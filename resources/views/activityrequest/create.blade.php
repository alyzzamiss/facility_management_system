...
<div class="container mt-5 mb-5">
    ...
    <div class="card">
        ...
        <div class="card-body">
            {!! Form::open(['action' => 'ActivityRequestsController@store', 'method' => 'POST']) !!}
            ...
            <div class="form-group row">
                <div class="col-lg-6">
                    ...
                    {{Form::text('activity_name', '', ['class' => 'form-control', 'placeholder' => 'e.g Palakasan, Charter Week'] )}}
                </div>
                <div class="col-lg-6">
            ...
            <div class="form-group row">
                <div class="col-lg-12">
                    ...
                    {{Form::textarea('activity_purpose', '', ['class' => 'form-control', 'placeholder' => 'Please provide a purpose for your activity.'] )}}
                </div>           
            </div>
            <div class="form-group row">
                <div class="col-lg-3">
